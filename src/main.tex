...
\begin{itemize}
    ...
    \item WLOG means "without loss of generailty", and is generally used when a proof for
    ...
    \begin{proof}
        ...
        = a$ and $d_1y_1 = b$. Now, considerer $d_2 = \gcd(ca,cb)$. There exist
...
\begin{itemize}
    ...
    a graph and the propositions as verteces, we are trying to make the graph fully
    connected.
